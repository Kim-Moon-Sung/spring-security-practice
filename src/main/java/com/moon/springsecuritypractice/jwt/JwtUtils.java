package com.moon.springsecuritypractice.jwt;
...
public class JwtUtils {
    ...
    public static String createToken(User user) {
        ...
        return Jwts.builder()
                ...
                .setIssuedAt(now) // 토근 발생 시간 정보
                .setExpiration(new Date(now.getTime() + JwtProperties.EXPIRATION_TIME)) // 토근 만료 시간 설정
